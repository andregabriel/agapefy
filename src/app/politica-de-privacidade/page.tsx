      ...
      try {
        ...
        if (error) {
          ...
          setDocument({
            ...
            title: 'Política de Privacidade – Agapefy',
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Carregando política de privacidade...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          <div className="prose prose-gray max-w-none">
            <h1 className="text-3xl font-bold text-gray-900 mb-6">
              {document?.title || 'Política de Privacidade – Agapefy'}
            </h1>
            ...
            <div className="text-center mt-12 pt-8 border-t border-gray-200">
              <p className="text-sm text-gray-500">
                Este documento contém a política completa de privacidade. Para questões específicas, entre em contato conosco através dos canais oficiais.
              </p>
              {document && (
